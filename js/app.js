...
var BookApp = angular.module('bookApp', ['ionic', 'starter.controllers', 'starter.services']);


BookApp.run(function ($ionicPlatform) {
...
BookApp.config(function ($stateProvider, $urlRouterProvider) {
    ...
    $urlRouterProvider.otherwise('/tab/blackboard');
